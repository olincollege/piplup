...
from planning import PlanarGraspSelector, COMPlanner
from kinova_gen3 import Gen3ControlMode
from common.logging import *
from common.utils import *


def run(*, scenario: Scenario, simulation=False, visualize=False):
    ...
    builder.Connect(
        ...
        com_planner.GetInputPort("planar_grasp_selection"),
    )

    builder.Connect(
        com_planner.GetOutputPort("control_mode"),
        hardware_station.GetInputPort("gen3.control_mode"),
    )

    builder.Connect(
        com_planner.GetOutputPort("arm_command"),
